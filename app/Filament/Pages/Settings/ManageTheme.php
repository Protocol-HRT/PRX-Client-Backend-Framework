            ...
            ->components([
                Section::make('Colors')
                    ...
                    ->components([
                        ...
                        ColorPicker::make('text_color')->label('Body text')->required(),
                        ColorPicker::make('accent_color')->label('Accent (gold)')->required(),
                        ColorPicker::make('accent_secondary_color')->label('Accent (secondary)')->required(),
                    ]),
                Section::make('Typography')
                    ->description('Font family names. The CSS @font-face files are bundled separately under public/fonts/.')
                    ->columns(2)
                    ->components([
                        TextInput::make('font_display')->label('Display font')->required()->maxLength(100),
                        TextInput::make('font_body')->label('Body font')->required()->maxLength(100),
                    ]),
            ])
            ->statePath('data');
    }
