            ...
            Section::make('Identity')
                ...
                ->components([
                    ...
                    Select::make('system_type')
                        ...
                        ->native(false)
                        ->live()
                        ->hintIcon(Heroicon::InformationCircle, 'Fulfillment provider type. Determines which credential fields appear below.')
                        ->helperText('Select the fulfillment provider — credential fields will appear below.'),
