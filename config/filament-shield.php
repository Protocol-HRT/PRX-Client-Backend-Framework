...
return [
    ...
    */
    ...
    'super_admin' => [
        'enabled' => true,
        'name' => 'super_admin',
        // Gate::before bypass: super_admin passes every ability automatically,
        // so newly added resources never silently drop out of super-admin
        // access between shield:generate runs.
